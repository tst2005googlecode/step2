...
public class SignerTest extends TestCase {
  ...
  private CertValidator validator =
      new CertValidator(ImmutableSet.of(CertConstantUtil.CA_PUB_CERT));
  ...
  public void testSign() throws Exception {
    ...
    Verifier v = new Verifier()
        ...
        .setCertValidator(validator)
        .setFetcher(new FakeFetcher(r.getSignatureLocation(), r.getSignature()));

    VerificationResult vr = v.verify();
  ...
  public void testBadSignature() throws Exception {
    ...
    Verifier v = new Verifier()
        .setDocument(EncodingUtil.getUtf8Bytes(tampered))
        .setCertValidator(validator)
        .setFetcher(new FakeFetcher(r.getSignatureLocation(), r.getSignature()));
    try {
      v.verify();
